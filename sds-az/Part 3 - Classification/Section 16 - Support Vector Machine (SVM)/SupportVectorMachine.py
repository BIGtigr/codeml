...
"""
Created on  : Wed Jun 27 00:31:09 2018
@author     : Sourabh
"""
...
# ---------------------------------------------------------------------------- #
# fitting the SVM classfier to the training data set
#classifier = SVC(
#        kernel = 'linear',  # assuming that the data is linearly distributed
#        random_state = 0
#        )
#
#classifier = SVC(
...
classifier = SVC(
        kernel = 'rbf',     # gaussian
        gamma = 0.5,        # optimal value = 1/n_features = 1/2 = 0.5
        random_state = 0
        )
